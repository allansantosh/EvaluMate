          ...
          ";
            ...
            for ($x = 1; $x <= $num_question; $x++) {
              ...
              if(isset($_POST["create_quiz"])){
                ...
                $sql = "INSERT INTO quiz (id, name, course, publish, proff, due, duration, quiz_type ) VALUES (NULL,'$quiz_name','$course_id','$pub_stat','$user_id','$date_time','$duration','$quiz_type')";
                ...
                if($result3) {
                   // echo "Success";
                    ...
                    echo "<script>window.location.replace('../create_quiz_status');</script>";
