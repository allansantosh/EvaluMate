   ...
   header("Location: ../login");
    ...
    if ($_SESSION['guesttype'] == "instructor"){
        ...
        if ($_SESSION['quiz_finish'] == "1"){
            ...
            AND quiz_q_and_a.id = student_answers.question_id WHERE student_answers.quiz_id = '".$_SESSION['quizid']."' and user_id = '".$_SESSION['guestid']."'";
      ...
      <div id="box">
        ...
        <h2 id="text">Your Score</h2>
           ...
           <?php
            ...
            $sqla = "INSERT INTO grades (id,user_id,quiz_id,grade) VALUES(NULL,'".$_SESSION['guestid']."','".$_SESSION['quizid']."','".round($final_score,2)."')";
        ...
        else if ($_SESSION['quiz_finish'] == "2"){
